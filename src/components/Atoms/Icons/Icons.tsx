...
function FacebookIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M24 12c0-6.627-5.373-12-12-12S0 5.373 0 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078V12h3.047V9.356c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953h-1.513c-1.49 0-1.953.925-1.953 1.874V12h3.328l-.532 3.469h-2.796v8.385C19.612 22.954 24 17.99 24 12z" />
    </svg>
  );
}
...
function InstagramIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M7 2C4.239 2 2 4.239 2 7v10c0 2.761 2.239 5 5 5h10c2.761 0 5-2.239 5-5V7c0-2.761-2.239-5-5-5H7zm10 2a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3h10zm-5 3.5A4.5 4.5 0 1 0 16.5 12 4.505 4.505 0 0 0 12 7.5zm0 7.5A3 3 0 1 1 15 12a3 3 0 0 1-3 3zm4.75-7.75a.75.75 0 1 1-.75-.75.75.75 0 0 1 .75.75z" />
    </svg>
  );
}
...
function ZaloIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 2C6.486 2 2 6.037 2 11c0 2.833 1.45 5.373 3.84 7.083L5 22l4.188-2.188C10.04 20.004 11.012 20 12 20c5.514 0 10-4.037 10-9s-4.486-9-10-9zm3.844 11.5h-7.7v-1.32l4.814-5.36H8.28V5.5h7.4v1.32l-4.815 5.36h4.98V13.5z" />
    </svg>
  );
}

function ArrowDownIcon({ expanded = false, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={16}
