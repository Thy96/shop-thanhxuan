...
function ProductItem({ data = product, className, style }: IProductInfo) {
  const thumbnail =
  ...
  return (
    <div className={classNames(styles.item, className)} style={style}>
      <Link href={`/san-pham/${data.slug}`} className={styles.archor}>
        <figure>
          <Image
            src={thumbnail}
            alt={data.title}
        ...
        <div className={styles.box_content}>
          <div className={styles.box_content_left}>
            ...
            <Paragraph level={4} className={styles.box_content_left_des}>
              {data.decription}
            </Paragraph>
            <div className={styles.box_content_left_price}>
              ...
              <Paragraph
                ...
                className={classNames(styles.price, {
                  [styles.line_through]: data.sale && data.sale > 0,
                })}
              >
